...
second one is a floating point number Y  representing the spent fuel total, with a digit after the decimal point.
...
x = int(input())  # type of integer
y = float(input())  # type of floating
print(f"{x / y:.3f}", "km/l")  # simple way
